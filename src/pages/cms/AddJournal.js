...
class AddJournal extends Component {
    ...
    handleFormSubmit = (e) => {
        ...
        if (!trip) {
            this.setState(
                { trip: document.getElementById("select-trip").value },
                () => {
                    this.addJournal()
                }
            )
                    ...
                    {currentTrip ? (
                        <Link to={`/admin/trip/${currentTrip._id}`}>
                            <img
                                ...
                                alt="Left"
                            />{" "}
                            <span>Back to {currentTrip.name}</span>
                        </Link>
                    ) : null}
                </BreadcrumbContainer>
                <InnerContainer>
                    ...
                    {status ? (
                        <React.Fragment>
                            ...
                            <YellowButton to={`${newJournalURL}`}>
                                View {title}
                            </YellowButton>
                            <GreenButton onClick={this.handleButtonClick}>
                                Create another
                            </GreenButton>
                        </React.Fragment>
                    ) : (
